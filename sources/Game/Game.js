...
import { TextureConfigs } from './TextureConfigs.js'
...
export class Game
{
    ...
    async init()
    {
        ...
        this.resources = await this.resourcesLoader.load([
            ...
            [ 'behindTheSceneStarsTexture', `behindTheScene/stars.${compressedTextureExtension}`,      compressedTextureFormat, (resource) => { TextureConfigs.sRGB(resource); resource.wrapS = THREE.RepeatWrapping; resource.wrapT = THREE.RepeatWrapping; } ],
        ...
        // Load rest of resources in parallel with RAPIER
        const resourcesPromise = this.resourcesLoader.load(
            [
                [ 'foliageTexture',                        `foliage/foliageSDF.${compressedTextureExtension}`,                              compressedTextureFormat, TextureConfigs.nearest ],
                ...
                [ 'terrainTexture',                        `terrain/terrain.${compressedTextureExtension}`,                                 compressedTextureFormat, TextureConfigs.terrain ],
                [ 'terrainModel',                          `terrain/terrain${compressedModelSuffix}.glb`,                                   'gltf' ],
                [ 'floorSlabsTexture',                     `floor/slabs.${compressedTextureExtension}`,                                     compressedTextureFormat, TextureConfigs.repeat ],
                ...
                [ 'whisperFlameTexture',                   `whispers/whisperFlame.${compressedTextureExtension}`,                           compressedTextureFormat, TextureConfigs.linear ],
                [ 'satanStarTexture',                      `areas/satanStar.${compressedTextureExtension}`,                                 compressedTextureFormat, TextureConfigs.linear ],
                [ 'tornadoPathReferencesModel',            `tornado/tornadoPathReferences${compressedModelSuffix}.glb`,                     'gltf' ],
                [ 'overlayPatternTexture',                 `overlay/overlayPattern.${compressedTextureExtension}`,                          compressedTextureFormat, (resource) => { resource.wrapS = THREE.RepeatWrapping; resource.wrapT = THREE.RepeatWrapping; TextureConfigs.nearest(resource); } ],
                [ 'interactivePointsKeyIconCrossTexture',  `interactivePoints/interactivePointsKeyIconCross.${compressedTextureExtension}`, compressedTextureFormat, TextureConfigs.nearest ],
                [ 'interactivePointsKeyIconEnterTexture',  `interactivePoints/interactivePointsKeyIconEnter.${compressedTextureExtension}`, compressedTextureFormat, TextureConfigs.nearest ],
